...
HELP_PARAGRAPH = (
    "<p>This is a big-picture atlas of software engineering — from the "
    "languages, data structures and algorithms at the core, through computer "
    "architecture, operating systems, networking, databases and distributed "
    "systems, up through software design, web and backend engineering, DevOps, "
    "cloud, security, testing, performance and the day-to-day craft of shipping "
    "software. The goal is to let you see the <b>whole territory at once</b> and "
    "mark <b>what you know vs. what you don't.</b></p>"
)
...
OLD_XLINK_TEXT = "⇄ Software Engineering map"
NEW_XLINK_TEXT = "⇄ AI / ML Knowledge map"
